...
Ok, output looks the same thus: 

### 1. Source problem lays in the reported data per se

### 2. In the matematical formulas used to calculate correlations from reported data
