...
# Update the meta-analysis model to use the new labels
# This ensures the new labels are carried through to the plot.
meta_model <- rma(
  yi, vi,
  data = analysis_data,
  method = "REML", 
...
# Create the plot
# This opens the graphics device and draws the main forest plot.
forest(meta_model,
...
# Get the prediction interval values
...
# Add text with the prediction interval
text(x = -3, y = -2.5, pos = 4, cex = 0.8, bquote(paste("Prediction Interval: [",
