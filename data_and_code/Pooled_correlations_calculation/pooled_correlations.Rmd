...
# Check if json key exists and if so, read it
if (file.exists(json_key)) {
  # Authenticate using the service accoun
...
file_path <- "~/Projects/loneliness-interventions-meta-analysis/Data/sheet_data.csv"
...
data_baez <- readr::read_csv2("~/Projects/loneliness-interventions-meta-analysis/Data/data_from_studies/data_Baez_et_al_2017.csv")
...
rmarkdown::render("~/Projects/loneliness-interventions-meta-analysis/Exploration_of_wierd_values/Exploration_of_wierd_values_of_correlation_coefficient.Rmd", output_file = "~/Projects/loneliness-interventions-meta-analysis/Exploration_of_wierd_values/Exploration_of_wierd_values_of_correlation_coefficient.html", quiet = TRUE)

# Include the rendered HTML in the main document
html_content <- paste(readLines("~/Projects/loneliness-interventions-meta-analysis/Exploration_of_wierd_values/Exploration_of_wierd_values_of_correlation_coefficient.html", warn = FALSE), collapse = "\n")
...
data %>% 
    select(
      ...
      Pre_Post_Correlation_Treatment,
      Pre_Post_Correlation_Control) %>% 
  write.xlsx(file = "~/Projects/loneliness-interventions-meta-analysis/Data/pre_post_correlations.xlsx")
```
