...
metafor::forest(
  ...
  showweights = FALSE,
  ilab        = ilab_mat,
  ilab.xpos   = c(-7.5, -6.0, -4.5),  # <-- adjust if you want tighter/wider spacing
  ilab.pos    = 4,
